...
1. **元数据审查** - 快速了解一个元数据包的结构和内容
2. **问题排查** - 分析继承关系、插件配置、字段定义等
3. **文档生成** - 自动生成元数据说明文档
4. **版本对比** - 比较不同版本的元数据差异
...
<DeployMetadata>
  ...
  <!-- 设计元数据集合 -->
  <DesignMetas>
    <DesignFormMeta>...</DesignFormMeta>
    <DesignEntityMeta>...</DesignEntityMeta>
    ...
  </DesignMetas>
</DeployMetadata>
```
